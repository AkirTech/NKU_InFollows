...
# 已经发布！第一个pre-release版本。
- 2026.5.8 发布第一个pre-release版本。
[`链接`](https://github.com/AkirTech/NKU_InFollows/releases/tag/Alpha-252Q2)


# 项目特色
- 使用C++与Qt，采取Qml搭建前端界面，保证高效性与简洁美观。
- 结合Python在爬虫等方面的优势，优化代码。
- 微信公众平台登录与爬取信息（借助[we-mp-rss](https://github.com/rachelos/we-mp-rss)项目）
- AI 驱动：利用AI技术对用户画像，进行个性化推荐。
- 与飞书紧密配合：一键添加任务，设置提醒，利用飞书的任务系统，追踪你的任务。(正在施工)
